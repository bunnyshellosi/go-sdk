...
// checks if the PaginatedProjectVariableCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedProjectVariableCollection{}

// PaginatedProjectVariableCollection Paginated result
type PaginatedProjectVariableCollection struct {
	Links        *PaginatedLinks                    `json:"_links,omitempty"`
	TotalItems   *int32                             `json:"totalItems,omitempty"`
	Page         *int32                             `json:"page,omitempty"`
	ItemsPerPage *int32                             `json:"itemsPerPage,omitempty"`
	Embedded     *EmbeddedProjectVariableCollection `json:"_embedded,omitempty"`
}
...
func NewPaginatedProjectVariableCollection() *PaginatedProjectVariableCollection {
	this := PaginatedProjectVariableCollection{}
	return &this
}
...
func (o *PaginatedProjectVariableCollection) GetEmbedded() EmbeddedProjectVariableCollection {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedProjectVariableCollection
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given EmbeddedProjectVariableCollection and assigns it to the Embedded field.
func (o *PaginatedProjectVariableCollection) SetEmbedded(v EmbeddedProjectVariableCollection) {
	o.Embedded = &v
}

func (o PaginatedProjectVariableCollection) MarshalJSON() ([]byte, error) {
...
func (o PaginatedProjectVariableCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedProjectVariableCollection struct {
	value *PaginatedProjectVariableCollection
	isSet bool
}

func (v NullablePaginatedProjectVariableCollection) Get() *PaginatedProjectVariableCollection {
	return v.value
}

func (v *NullablePaginatedProjectVariableCollection) Set(val *PaginatedProjectVariableCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedProjectVariableCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedProjectVariableCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedProjectVariableCollection(val *PaginatedProjectVariableCollection) *NullablePaginatedProjectVariableCollection {
	return &NullablePaginatedProjectVariableCollection{value: val, isSet: true}
}

func (v NullablePaginatedProjectVariableCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedProjectVariableCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
