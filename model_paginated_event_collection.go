...
// checks if the PaginatedEventCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedEventCollection{}
...
func (o PaginatedEventCollection) ToMap() (map[string]interface{}, error) {
