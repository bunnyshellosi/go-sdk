...
type ApiEnvironmentAbortRequest struct {
	ctx        context.Context
...
// No Request Body
func (r ApiEnvironmentAbortRequest) Body(body interface{}) ApiEnvironmentAbortRequest {
	r.body = &body
	return r
}

func (r ApiEnvironmentAbortRequest) Execute() (*EventItem, *http.Response, error) {
	return r.ApiService.EnvironmentAbortExecute(r)
}

/*
EnvironmentAbort Abort the current and queued environment workflows.

Abort the current and queued environment workflows.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Resource identifier
	@return ApiEnvironmentAbortRequest
*/
func (a *EnvironmentAPIService) EnvironmentAbort(ctx context.Context, id string) ApiEnvironmentAbortRequest {
	return ApiEnvironmentAbortRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return EventItem
func (a *EnvironmentAPIService) EnvironmentAbortExecute(r ApiEnvironmentAbortRequest) (*EventItem, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentAbort")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/environments/{id}/abort"
...
type ApiEnvironmentEditBuildSettingsRequest struct {
	ctx                                context.Context
	ApiService                         *EnvironmentAPIService
	id                                 string
	environmentEditBuildSettingsAction *EnvironmentEditBuildSettingsAction
}

// The updated environment resource
func (r ApiEnvironmentEditBuildSettingsRequest) EnvironmentEditBuildSettingsAction(environmentEditBuildSettingsAction EnvironmentEditBuildSettingsAction) ApiEnvironmentEditBuildSettingsRequest {
	r.environmentEditBuildSettingsAction = &environmentEditBuildSettingsAction
	return r
}

func (r ApiEnvironmentEditBuildSettingsRequest) Execute() (*EnvironmentItem, *http.Response, error) {
	return r.ApiService.EnvironmentEditBuildSettingsExecute(r)
}

/*
EnvironmentEditBuildSettings Edit the build settings of an environment.

Edit the build settings of an environment.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Resource identifier
	@return ApiEnvironmentEditBuildSettingsRequest
*/
func (a *EnvironmentAPIService) EnvironmentEditBuildSettings(ctx context.Context, id string) ApiEnvironmentEditBuildSettingsRequest {
	return ApiEnvironmentEditBuildSettingsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return EnvironmentItem
func (a *EnvironmentAPIService) EnvironmentEditBuildSettingsExecute(r ApiEnvironmentEditBuildSettingsRequest) (*EnvironmentItem, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentEditBuildSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/environments/{id}/build-settings"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.environmentEditBuildSettingsAction == nil {
		return localVarReturnValue, nil, reportError("environmentEditBuildSettingsAction is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.environmentEditBuildSettingsAction
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["JWT"]; ok {
...
type ApiEnvironmentEditDrunnerSettingsRequest struct {
	ctx                                           context.Context
	ApiService                                    *EnvironmentAPIService
	id                                            string
	environmentEditDeploymentRunnerSettingsAction *EnvironmentEditDeploymentRunnerSettingsAction
}

// The updated environment resource
func (r ApiEnvironmentEditDrunnerSettingsRequest) EnvironmentEditDeploymentRunnerSettingsAction(environmentEditDeploymentRunnerSettingsAction EnvironmentEditDeploymentRunnerSettingsAction) ApiEnvironmentEditDrunnerSettingsRequest {
	r.environmentEditDeploymentRunnerSettingsAction = &environmentEditDeploymentRunnerSettingsAction
	return r
}

func (r ApiEnvironmentEditDrunnerSettingsRequest) Execute() (*EnvironmentItem, *http.Response, error) {
	return r.ApiService.EnvironmentEditDrunnerSettingsExecute(r)
}

/*
EnvironmentEditDrunnerSettings Edit the deployment runner settings of an environment.

Edit the deployment runner settings of an environment.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Resource identifier
	@return ApiEnvironmentEditDrunnerSettingsRequest
*/
func (a *EnvironmentAPIService) EnvironmentEditDrunnerSettings(ctx context.Context, id string) ApiEnvironmentEditDrunnerSettingsRequest {
	return ApiEnvironmentEditDrunnerSettingsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return EnvironmentItem
func (a *EnvironmentAPIService) EnvironmentEditDrunnerSettingsExecute(r ApiEnvironmentEditDrunnerSettingsRequest) (*EnvironmentItem, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentEditDrunnerSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/environments/{id}/deployment-runner-settings"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.environmentEditDeploymentRunnerSettingsAction == nil {
		return localVarReturnValue, nil, reportError("environmentEditDeploymentRunnerSettingsAction is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.environmentEditDeploymentRunnerSettingsAction
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["JWT"]; ok {
