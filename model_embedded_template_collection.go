...
// checks if the EmbeddedTemplateCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedTemplateCollection{}
...
func (o EmbeddedTemplateCollection) ToMap() (map[string]interface{}, error) {
