...
// checks if the EnvironItemItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironItemItem{}

// EnvironItemItem An environment variable used during Bunnyshell workflows.
type EnvironItemItem struct {
...
func (o *EnvironItemItem) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o EnvironItemItem) MarshalJSON() ([]byte, error) {
...
func (o EnvironItemItem) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironItemItem struct {
	value *EnvironItemItem
	isSet bool
}

func (v NullableEnvironItemItem) Get() *EnvironItemItem {
	return v.value
}

func (v *NullableEnvironItemItem) Set(val *EnvironItemItem) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironItemItem) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironItemItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironItemItem(val *EnvironItemItem) *NullableEnvironItemItem {
	return &NullableEnvironItemItem{value: val, isSet: true}
}

func (v NullableEnvironItemItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironItemItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
