...
// checks if the PaginatedRegistryIntegrationCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedRegistryIntegrationCollection{}

// PaginatedRegistryIntegrationCollection Paginated result
type PaginatedRegistryIntegrationCollection struct {
	Links        *PaginatedLinks                        `json:"_links,omitempty"`
	TotalItems   *int32                                 `json:"totalItems,omitempty"`
	Page         *int32                                 `json:"page,omitempty"`
	ItemsPerPage *int32                                 `json:"itemsPerPage,omitempty"`
	Embedded     *EmbeddedRegistryIntegrationCollection `json:"_embedded,omitempty"`
}
...
func NewPaginatedRegistryIntegrationCollection() *PaginatedRegistryIntegrationCollection {
	this := PaginatedRegistryIntegrationCollection{}
	return &this
}
...
func (o *PaginatedRegistryIntegrationCollection) GetEmbedded() EmbeddedRegistryIntegrationCollection {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedRegistryIntegrationCollection
		return ret
	}
	return *o.Embedded
}
...
// SetEmbedded gets a reference to the given EmbeddedRegistryIntegrationCollection and assigns it to the Embedded field.
func (o *PaginatedRegistryIntegrationCollection) SetEmbedded(v EmbeddedRegistryIntegrationCollection) {
	o.Embedded = &v
}

func (o PaginatedRegistryIntegrationCollection) MarshalJSON() ([]byte, error) {
...
func (o PaginatedRegistryIntegrationCollection) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedRegistryIntegrationCollection struct {
	value *PaginatedRegistryIntegrationCollection
	isSet bool
}

func (v NullablePaginatedRegistryIntegrationCollection) Get() *PaginatedRegistryIntegrationCollection {
	return v.value
}

func (v *NullablePaginatedRegistryIntegrationCollection) Set(val *PaginatedRegistryIntegrationCollection) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedRegistryIntegrationCollection) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedRegistryIntegrationCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedRegistryIntegrationCollection(val *PaginatedRegistryIntegrationCollection) *NullablePaginatedRegistryIntegrationCollection {
	return &NullablePaginatedRegistryIntegrationCollection{value: val, isSet: true}
}

func (v NullablePaginatedRegistryIntegrationCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedRegistryIntegrationCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
