# EnvironmentCreateActionGenesis
...
`func NewEnvironmentCreateActionGenesis(url string, branch string, yamlPath string, spec string, yaml string, template string, ) *EnvironmentCreateActionGenesis`
...
`func (o *EnvironmentCreateActionGenesis) SetType(v string)`
