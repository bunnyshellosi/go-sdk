...
// checks if the OrganizationCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationCollection{}
...
func (o OrganizationCollection) ToMap() (map[string]interface{}, error) {
